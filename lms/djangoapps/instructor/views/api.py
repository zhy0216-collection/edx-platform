...
def create_manual_course_enrollment(enrolled_user, course_id, mode, enrolled_by, reason, state_transition):
    """
    Create course enrollment for the given student and create manual enrollment audit trail.

    :param enrolled_user: User who is to enroll in course
    ...
    """
    enrollment_obj = CourseEnrollment.enroll(enrolled_user, course_id, mode=mode)
    ManualEnrollmentAudit.create_manual_enrollment_audit(
        enrolled_by, enrolled_user.email, state_transition, reason, enrollment_obj
    )

    log.info(u'user %s enrolled in the course %s', enrolled_user.username, course_id)
